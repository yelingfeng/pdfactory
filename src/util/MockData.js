...
CD[FUSIONCHART][BAR] =  {
  ...
  "4":[
    { label: "测试01",  value:  "-1.33", group: "a"},
    { label: "测试02",  value: "-0.27", group: "b"},
    { label: "测试03", value: "0.40", group: "a"},
    { label: "测试04",  value: "1.6", group: "b"},
    { label: "测试05", value: "-1.2", group: "a" },
    { label: "测试06", value: "-2.2", group: "b"},
    { label: "测试07", value: "3.2", group: "a" },
    { label: "测试08", value: "-2.2", group: "b"}
  ],
  "5" :[
    {label:"测试01",value:"80000",group: "a"},
    {label:"测试02",value:"70000", group: "b"},
    {label:"测试03",value:"60000",group: "a"},
    {label:"测试04",value:"55000", group: "b"},
    {label:"测试05",value:"45000",group: "a"},
    {label:"测试06",value:"35000", group: "b"},
    {label:"测试07",value:"33000",group: "a"},
    {label:"测试08",value:"32000", group: "b"},
    {label:"测试09",value:"30000",group: "a"},
    {label:"测试10",value:"25000", group: "b"}
  ]

};
CD[FUSIONCHART][LINE] =  {
  "0" : [
    { label: '2013-01', group: '北京', value: 1 ,info:"0.15"},
    { label: '2013-01', group: '上海', value: 0.12,info:"0.1" },
    { label: '2013-01', group: '广州', value: 0.12 ,info:"0.1"},
    { label: '2013-01', group: '沈阳', value: 0.23 ,info:"0.2"},
    { label: '2013-02', group: '北京', value: 0.54,info:"0.5" },
    { label: '2013-02', group: '上海', value: 0.91 ,info:"1"},
    { label: '2013-02', group: '广州', value: 0.75 ,info:"0.7"},
    { label: '2013-02', group: '沈阳', value: 0.52 ,info:"0.5"},
    { label: '2013-03', group: '北京', value: 0.31 ,info:"0.3"},
    { label: '2013-03', group: '上海', value: 0.21 ,info:"0.21"},
    { label: '2013-03', group: '广州', value: 0.17 ,info:"0.1"},
    { label: '2013-03', group: '沈阳', value: 0.28 ,info:"0.2"}
  ],
  "1" : [
    { label: '2013-01', group: '北京', value: 1 ,info:"0.15"},
    { label: '2013-01', group: '上海', value: 0.12,info:"0.1" },
...
CD[FUSIONCHART][PIE]={
  "0" : [
    { label: 'A', group: '上海' , value: 1 ,info:"0.15"},
    { label: 'B', group: '上海', value: 0.12,info:"0.1" },
  ],
  "1" : [
    { label: 'A', group: '上海' , value: 1 ,info:"1"},
    { label: 'B', group: '上海', value: 0.12,info:"0.12" },
  ],
  /*"2" : [
  { label: 'A', group: '上海' , value: 1 ,info:"0.15"},
  { label: 'B', group: '上海', value: 0.12,info:"0.1" },
...
CD[FUSIONCHART][PYRAMID] = {
  "0" :[{ label: '数据A', value: 10 ,info:"dddddddddddddddd"},
  { label: '数据C', value: 20,info:"cccc"},
  { label: '数据B', value: 40,info:"eeee"},
  { label: '数据D', value: 30,info:"fffff"},
  { label: '数据E', value: 50,info:"qqqqq"},
  { label: '数据F', value: 70,info:"aaaaaa"}
]
};
CD[FUSIONCHART][HORIZONTAL] = {
  "0":[{name: '数据A', value: 70 ,info:"dddddddddddddddd"}]
};
CD[FUSIONCHART][HEATMAP] = {
  "1":[{ rowid: "aa",columnid: "11",value: "5", info:"dddddddddddddddd"},
  {  rowid: "aa",columnid: "22",value: "5", info:"3333"},
  {  rowid: "aa",columnid: "33",value: "5", info:"44444"},
  {  rowid: "aa",columnid: "44",value: "5", info:"555"},
  {  rowid: "aa",columnid: "55",value: "5", info:"6666"},
  {  rowid: "aa",columnid: "66",value: "5", info:"7777"},
  {  rowid: "aa",columnid: "77",value: "5", info:"88888"},
  {  rowid: "aa",columnid: "88",value: "5", info:"99999"},
  {  rowid: "aa",columnid: "99",value: "5", info:"11123123123213"}
]
};
CD[FUSIONCHART][STATUS] = {
  "0" :[ { label: '数据A', value: 70 ,info:"dddddddddddddddd"}]
};
...
// 获得图表数据
function getChartData(categoryType,type,childType){
  childType = childType == undefined ? "0" : childType;
  var data = CD[categoryType][type][childType];
  return data;
}
...
function getSearchData(categoryType,type,childType) {
  return EMPTY_DATA;
}
...
* @param categoryType 图表类别 (funionchart,echart) 没有可以是NULL
* @param type    组件类别
* @param childType  组件子类型
* @returns
*/
function MorkData(componentType,categoryType,type,childType) {

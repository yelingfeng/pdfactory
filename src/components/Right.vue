<template>
    ...
    <ul class="nav" id="zRight_component" class="textAttrUl">
                            <li class="nav_c_con">
                                <strong class="nav_c_title">基本属性</strong>
                                <ul class="baseAttr"  rel="base" >
                                    <li><span class="f12_2f5a93">控件名称：</span><span class="f12_2f5a93 w120" id="zR_baseName">图标型控件A</span></li>
                                    <li>
        								<div class="lineBox"><span class="f12_2f5a93 m_t_3">控件标题：</span><input class="w80" type="text" id="zTitle"><input class="ttlDt" type="button"></div>
        								<div class="lineBox">
    							    	...
    							    	<div class="lineBox baseAttrFont" prop-type="fontOther">
        									<i class="B m_l_60">B</i>
    								    	<i class="I">I</i>
    								    	<i class="U">U</i>
    								    	<i class="A" id="titleFontColor">A</i>
    							    	</div>
    								    <div class="lineBox baseAttrTitlePst" prop-type="fontOther">
    								    	<span class="f12_2f5a93 m_t_3">位置：</span>
                                    ...
                                    <li><span class="f12_2f5a93 m_t_3">控件注释：</span><input class="w122" type="text" id="zR_remark"></li>
        							<li>
        								<dl>
    	    								<dt class="f12_2f5a93 m_t_3 t_align_l">位置大小：</dt>
    	    								<dd class="control-style"  rel="size">
    									        <div class="m_b_10"><span>左</span><input type="text" class="f12_2f5a93" id="t_align_left" data-attr="position_l"></div>
    									        <div class="m_b_10"><span>上</span><input type="text" class="f12_2f5a93" id="t_align_top" data-attr="position_t"></div>
    									        <div><span>宽</span><input type="text" class="f12_2f5a93" id="t_width" data-attr="position_w"></div>
    									        <div><span>高</span><input type="text" class="f12_2f5a93" id="t_height" data-attr="position_h"></div>
    										</dd>
        								</dl>
        							</li>
    					    		<li>
    							    	<dl>
    										<dt class="f12_2f5a93 m_t_3 t_align_l">控件边框：</dt>
    										<dd class="control-look"  rel="border">
        										<span class="line-none"></span><span class="line-has"></span>
    										</dd>
    									</dl>
    						    	</li>
    						    	<li>
                            ...
                            <li class="nav_c_con">
                                <strong class="nav_c_title">通用属性</strong>
        						<ul class="baseAttr"  rel="common" >
        							<li class="propDpyNone">
        								<span class="compLabelName">背景色：</span><div class="compName" id="bgColor"></div>
        							</li>
    						    	<li>
    						    		<div class="lineBox" prop-type="spcPropCheck">
    								    	<input type="checkbox" class="check" id="showLegend" valName="showLegend" propType="2">
    								        <span class="checkBoxDescription"><label for="showLegend">显示图例</label></span>
    						    		</div>
        								<div class="lineBox legendBox">
    								    	<span class="compLabelName m_l_20">图例位置：</span>
    						    	...
    						    	<li class="propDpyNone">
        								<div class="lineBox">
    										<span class="compLabelName">图表文字：</span>
    						    	...
    						    	<li id="labelDPY">
        								<div class="lineBox">
    										<span class="compLabelName">坐标方向：</span>
    							    	...
    							    	<div class="lineBox propDpyNone" id="axis3" prop-type="commonPropText">
    										<span class="compLabelName">倾斜角度：</span>
    										<input class="w122" type="text" id="axis3Input" valname="deg">
    									</div>
    								</li>
    						    	<li id="labelStep">
        								<div class="lineBox" prop-type="commonPropText">
    										<span class="compLabelName">显示间隔：</span>
    				    	...
    				    	<li class="nav_c_con">
    					        <strong class="nav_c_title">专有属性</strong>
        						<div>
    							<ul class="baseAttr"  rel="specialBar" >
    								<li class="propDpyNone">
    									<span class="compLabelName">柱形颜色：</span><div class="compName" id="barColor"></div>
    								</li>
    						    	<li class="propDpyNone">
        								<div class="lineBox">
    										<span class="compLabelName">坐标：</span>
    						    	...
    						    	<li prop-type="barAxis">
        								<div class="lineBox">
    										<div><span class="compLabelName">横轴名称：</span><input class="w122" type="text" valName="xName"></div>
        									<div class="m_t_5 fl"><span class="compLabelName">横轴单位：</span><input class="w122" type="text" valName="xUnit"></div>
        								</div>
    							    	<div class="lineBox">
        									<div><span class="compLabelName">左纵名称：</span><input class="w122" type="text" valName="ylName"></div>
    										<div class="m_t_5 fl"><span class="compLabelName">左纵单位：</span><input class="w122" type="text" valName="ylUnit"></div>
    									</div>
    							    	<div class="lineBox" showid="bar-specialAxisInput3">
        									<div><span class="compLabelName">右纵名称：</span><input class="w122" type="text"  valName="yrName"></div>
    										<div class="m_t_5 fl"><span class="compLabelName">右纵单位：</span><input class="w122" type="text" valName="yrUnit"></div>
    									</div>
    								</li>
    					    		<li prop-type="barAxisVal" id="barMM">
    					    			<dt class="f12_2f5a93 t_align_l">坐标极值：</dt>
    					    			<dd class="ddBox propDpyNone">
    					    				<em>横轴</em>
    								    	<em class="">Min</em>
    								    	<input type="text" valName="xMin">
    								    	<em class="m_l_15">Max</em>
    								    	<input class="" type="text" valName="xMax">
    					    			</dd>
    							    	<dd class="ddBox">
    										<em>左纵</em>
    								    	<em class="">Min</em>
    								    	<input class="" type="text" valName="ylMin">
    								    	<em class="m_l_15">Max</em>
    								    	<input type="text" valName="ylMax">
    									</dd>
    							    	<dd class="ddBox" showId="bar-specialAxisMM3">
    										<em>右纵</em>
    								    	<em class="">Min</em>
    								    	<input class="" type="text" valName="yrMin">
    								    	<em class="m_l_15">Max</em>
    						    	...
    						    	<li>
    							    	<div class="lineBox" prop-type="spcPropCheck">
    								    	<input type="checkbox" id="chk2" class="check" name="check" valName = "showBarVal" propType="3">
    								        <span class="checkBoxDescription"><label for="chk2">显示图表值</label></span>
    									</div>
    								</li>
    					    	</ul>
    					    	<ul class="baseAttr"  rel="specialBarstrip">
    						    	<li class="propDpyNone">
    									<span class="compLabelName">条形颜色：</span><div class="compName" id="barstripColor"></div>
    								</li>
    						    	<li class="propDpyNone">
    									<div class="lineBox">
    										<span class="compLabelName">坐标：</span>
    								...
    								<li prop-type="barAxis">
    									<div class="lineBox">
    										<span class="compLabelName">纵轴单位：</span><input class="w122" type="text" valName="ylUnit">
    									</div>
    							    	<div class="lineBox">
    										<span class="compLabelName">下横名称：</span><input class="w122" type="text" valName="xbName">
    									</div>
    							    	<div class="lineBox">
    										<span class="compLabelName">下横单位：</span><input class="w122" type="text" valName="xbUint">
    									</div>
    							    	<div class="lineBox propDpyNone" showid="barstrip-specialAxisInput3">
    										<span class="compLabelName">上横名称：</span><input class="w122" type="text" valName="xtName">
    									</div>
    							    	<div class="lineBox propDpyNone" showid="barstrip-specialAxisInput3">
    										<span class="compLabelName">上横单位：</span><input class="w122" type="text" valName="xtUint">
    									</div>
    								</li>
    								<li prop-type="barAxisVal" id="barstripMM">
    									<dt class="f12_2f5a93 t_align_l">坐标极值：</dt>
    									<dd class="ddBox propDpyNone">
    										<em>纵轴</em>
    								    	<em class="">Min</em>
    								    	<input type="text" valName="yMin">
    								    	<em class="m_l_15">Max</em>
    							    	...
    							    	<dd class="ddBox">
    										<em>下横</em>
    								    	<em class="">Min</em>
    								    	<input class="" type="text" valName="xbMin">
    								    	<em class="m_l_15">Max</em>
    								    	<input type="text" valName="xbMax">
    									</dd>
    							    	<dd class="ddBox" showId="barstrip-specialAxisMM3">
    										<em>上横</em>
    								    	<em class="">Min</em>
    								    	<input class="" type="text" valName="xtMin">
    								    	<em class="m_l_15">Max</em>
    						    	...
    						    	<li class="propDpyNone">
    							    	<div class="lineBox" prop-type="spcPropCheck">
    								    	<input type="checkbox" class="check" name="check" id="showValPct" valName = "showValPct" propType="3">
    								        <span class="checkBoxDescription"><label for="showValPct">显示指标占比</label></span>
    									</div>
    						    	</li>
    						    	<li>
    							    	<div class="lineBox" prop-type="spcPropCheck">
    								    	<input type="checkbox" id="chk1" class="check" name="check" valName = "showPiePercent" propType="3">
    								        <span class="checkBoxDescription"><label for="chk1">显示指标占比</label></span>
    									</div>
    								</li>
    					    	</ul>
    					    	<ul class="baseAttr"  rel="specialLine">
    						    	<li class="propDpyNone">
    							    	<span class="compLabelName">线条类型：</span>
    						    	...
    						    	<li class="propDpyNone">
    									<span class="compLabelName">线条颜色：</span><div class="compName" id="LineColor"></div>
    								</li>
    						    	<li id="lineAxis">
    									<div class="lineBox">
    										<span class="compLabelName">坐标：</span>
    								...
    								<li prop-type="barAxis">
    							    	<div class="lineBox">
    										<span class="compLabelName">横轴名称：</span><input class="w122" type="text" valName="xName">
    									</div>
    									<div class="lineBox">
    										<span class="compLabelName">横轴单位：</span><input class="w122" type="text" valName="xUnit">
    									</div>
    							    	<div class="lineBox">
    										<span class="compLabelName">左纵名称：</span><input class="w122" type="text" valName="ylName">
    									</div>
    							    	<div class="lineBox">
    										<span class="compLabelName">左纵单位：</span><input class="w122" type="text" valName="ylUnit">
    									</div>
    							    	<div class="lineBox" showid="line-specialAxisInput3">
    										<span class="compLabelName">右纵名称：</span><input class="w122" type="text" valName="yrName">
    									</div>
    							    	<div class="lineBox" showid="line-specialAxisInput3">
    										<span class="compLabelName">右纵单位：</span><input class="w122" type="text" valName="yrUnit">
    									</div>
    								</li>
    								<li prop-type="barAxisVal" id="lineMM">
    									<dt class="f12_2f5a93 t_align_l">坐标极值：</dt>
    									<dd class="ddBox propDpyNone">
    										<em>横轴</em>
    								    	<em class="">Min</em>
    							    	...
    							    	<dd class="ddBox">
    										<em>左纵</em>
    								    	<em class="">Min</em>
    								    	<input type="text" valName="ylMin">
    								    	<em class="m_l_15">Max</em>
    								    	<input type="text" valName="ylMax">
    									</dd>
    							    	<dd class="ddBox propDpyNone" showId="line-specialAxisMM3">
    										<em>右纵</em>
    								    	<em class="">Min</em>
    								    	<input class="" type="text" valName="yrMin">
    								    	<em class="m_l_15">Max</em>
    						    	...
    						    	<li>
    							    	<div class="lineBox" prop-type="spcPropCheck" id="linePoint">
    								    	<input type="checkbox" class="check" name="check" checked="true" id="showLinePoint" valName = "showLinePoint" propType="3">
    								        <span class="checkBoxDescription"><label for="showLinePoint">显示线条节点</label></span>
    									</div>
    						    	</li>
    						    	<li>
    							    	<div class="lineBox" prop-type="spcPropCheck" id="lineVal">
    								    	<input type="checkbox" id="chkLine" class="check" name="check" valName = "showLineVal" propType="3">
    								        <span class="checkBoxDescription"><label for="chkLine">显示图表值</label></span>
    									</div>
    								</li>
    							</ul>
    				    	<ul class="baseAttr" rel="specialPie" >
    							<li class="propDpyNone">
    								<span class="compLabelName">环形颜色：</span><div class="compName" id="pieColor"></div>
    							</li>
    					    	<li class="propDpyNone" prop-type="piePropVal">
    								<div class="lineBox">
    									<span class="compLabelName">环内半径：</span>
    									<input class="w122" type="text" valname="pieR">
    								</div>
    							</li>
    					    	<li class="propDpyNone" prop-type="piePropVal">
    								<div class="lineBox">
    									<span class="compLabelName">圆心距：</span>
    									<input class="w122" type="text" valname="centerR">
    								</div>
    							</li>
    					    	<li prop-type="piePropVal" id="zbz">
    						    	<div class="lineBox">
    									<span class="compLabelName">占比值：</span>
    									<input class="w122" type="text" valname="pieShowPercent" placeholder="2">
    								</div>
    							</li>
    					    	<li>
    						    	<div class="lineBox" prop-type="spcPropCheck">
        								<input type="checkbox" class="check" id="chk3" name="check" valName = "showPieName" propType="3">
    							        <span class="checkBoxDescription"><label for="chk3">名称</label></span>
    								</div>
    						    	<div class="lineBox" prop-type="spcPropCheck">
    									<input type="checkbox" class="check" id="chk33" name="check" valName = "showPiePercent" rel="group" propType="3">
    							        <span class="checkBoxDescription"><label for="chk33">百分比</label></span>
    							    </div>
    						    	<div class="lineBox" prop-type="spcPropCheck">
    									<input type="checkbox" class="check" id="chk333" name="check" valName = "showPieValues" rel="group" propType="3">
    							        <span class="checkBoxDescription"><label for="chk333">值</label></span>
    						    	</div>
    							</li>
    				    	</ul>
    				    	<ul class="baseAttr" rel="specialMap" >
    						    ...
    						    <li>
    						    	<div class="lineBox" prop-type="spcPropCheck">
    							    	<input type="checkbox" class="check" name="check" id="showRestoreVal" valName="showRestoreVal" propType="2">
    							        <span class="checkBoxDescription"><label for="showRestoreVal">显示刷新</label></span>
    								</div>
    							</li>
    				    	</ul>
    				    	<ul class="baseAttr" rel="specialTimepick" >
    					    	<li>
    				    			<div class="lineBox" prop-type="spTimePropCheck">
    									<input type="checkbox" class="check" id="st-quarter-checked" >
    									<span class="checkBoxDescription"><label for="st-quarter-checked">刻</label></span>
    								</div>
        							<div class="lineBox" prop-type="spTimePropCheck">
        								<input type="checkbox" class="check" id="st-hour-checked" >
    						    		<span class="checkBoxDescription"><label for="st-hour-checked">小时</label></span>
        							</div>
        							<div class="lineBox" prop-type="spTimePropCheck">
    									<input type="checkbox" class="check" id="st-day-checked" >
    									<span class="checkBoxDescription"><label for="st-day-checked">天</label></span>
    								</div>
    					    	</li>
        						<li>
    					    	 	<div class="lineBox" prop-type="spTimePropCheck">
    					    			<span class="compLabelName">默认选中：</span>
    					    	...
    					    	<li>
    							 	<div class="lineBox" prop-type="spTimePropCheck">
    									<span class="compLabelName">粒度大小：</span>
    						    ...
    						    <li>
    							 	<div class="lineBox" prop-type="spTimePropCheck">
    									<span class="compLabelName">时间格式：</span>
    						    ...
    						    <li>
    								<div class="lineBox" >
    									<input type="checkbox" class="check" id="st-isFixed-checked" >
    									<span class="checkBoxDescription"><label for="st-isFixed-checked">是否固定刻度</label></span>
    								</div>
    							</li>
    				    	</ul>
        					</div>
                            ...
                            <li class="nav_c_con">
                                <strong class="nav_c_title">数据与级联</strong>
                                    <ul class="control-look"  rel="data">
                                    <li><span><input class="picChs" type="button" value="配置" id="dataSetting_btn"></span></li>
                                    <li><span class="f12_2f5a93">当前控件的数据源：</span><div><span class="f12_000" id="zR_dataSource"></span><span></span></div></li>
                                    <li><span class="f12_2f5a93">当前控件的父控件：</span><div class="c_list" id="zR_parentCom"></div></li>
                                </ul>
                            </li>
                        </ul>
                        </div>
                              	 ...
                              	 if(zRight.option.component.props){
                  	       		 ...
                  	       		 if(checked){
                  	       			...
                  	       			if(zRight.option.chartCategory == "f_chart"){
                          				var legendAlignOpt = $("select[xname='legendPositon']", "ul[rel='common']").find("option[chart-type='f_chart']");
                          				$(".legendBox").find("option[chart-type='e_chart']").hide();
                  	            			...
                  	            			for(var i=0; i<legendAlignOpt.length; i++){
                  	                			if(commonProp.legendPositon == $(legendAlignOpt[i]).attr("value") ){
                  	                				$(legendAlignOpt[i]).attr("selected","selected").siblings("option").removeAttr("selected");
                  	                    		}
                  	                		}
                  	            		}else{
                          				...
                          				var legendAlignOpt = $("select[xname='legendPositon']", "ul[rel='common']").find("option[chart-type='e_chart']");
                  	            ...
                  	            $('#'+id).jPicker({
                  	            	window:{
                  			            ...
                  			            color:
                  			            {
                  			              ...
                  			              active: new $.jPicker.Color({ hex: me.defaultColor }), // accepts any declared jPicker.Color object or hex string WITH OR WITHOUT '#'
                  		            ...
                  		            commitCallback,
                  		            function liveCallback(color, context, input){
                  		                if(color.val() == null){
                  		                  return false;
                  		                }
                  		            },
                  		 ...
                  		 propertiesBindEvent : function(){
                  			...
                  			$("div[prop-type='commonPropText']", me.compBox).find("input[type='text']").on("blur", function(){
                  			    ...
                  			    if(!reg.test( $(this).val() )){
                  			       	$(this).css({"color":"#FD0808"});
                  			        $(this).focus();
                  			    }else{
                  			    	$(this).css({"color":"##2f5a93"});
                  			    	var axisdata = {
